...
import { signUpWithEmail, signInWithGoogle, createCompany, createUserProfile } from '@/lib/supabase/auth'
...
export default function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        setStep(2) // Show email verification step
      }
    } catch (err) {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      // If successful, user will be redirected via OAuth flow to onboarding
    } catch (err) {
      setError('An unexpected error occurred')
      setLoading(false)
    }
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Click the link in your email to verify your account and complete the setup.
            </p>
          </div>
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            Create your Looped account
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Start providing AI-powered support to your team
          </p>
        </div>
